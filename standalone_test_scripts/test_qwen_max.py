...
test_qwen_max.py
────────────────
Tests that qwen3-max (DashScope) works as a drop-in replacement for Groq
...
Tests:
  ...
  3. _get_fast_llm() returns a ChatOpenAI with qwen3-max, not Groq
...
print("\n══════════════════════════════════════════════════════════")
print("  qwen3-max (DashScope) Integration Tests")
print("══════════════════════════════════════════════════════════\n")
...
# ─── TEST 3: _get_fast_llm() uses qwen3-max ────────────────────────────────────
print("▶ TEST 3: _get_fast_llm() is configured for qwen3-max")
try:
    import tools
    ...
    check("model is qwen3-max",          "qwen3-max" in str(model_name))
...
if passed == total:
    print("  🎉 All qwen3-max tests passed — safe to deploy!")
else:
